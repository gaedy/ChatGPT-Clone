  ...
  return (
    <div className='w-full h-full flex flex-col text-sm'>
      ...
      <div className='flex flex-col gap-4 mr-10 ml-2 text-pretty text-ahTextColor '>
        <div className='text-xs'>ChatGPT will become more helpful as you chat, picking up on details
      ...
      <div className='flex flex-row justify-between my-auto'>
          ...
          <div className='hover:bg-red-600 bg-red-500 py-2 px-5 border border-ahBorderColor rounded-full cursor-pointer'>Clear ChatGPT's memory</div>
        </div>
