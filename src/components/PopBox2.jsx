...
function PopBox2({ isOpen, refProp }) {
  ...
  return (
    <div
      className="bg-ahHoverColor text-ahTextColor00 border border-ahBorderColor fixed top-14  right-4 w-64 h-fit z-10
