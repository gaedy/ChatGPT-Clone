...
function DataControl() {
  return (
    <div className='w-full h-full flex flex-col text-sm'>
      ...
      <div className='flex flex-row justify-between items-center'>
        <div>Export data</div>
        <div className='hover:bg-ahBorderColor py-2 px-5 border border-ahBorderColor rounded-full cursor-pointer'>Export</div>
      </div>
      ...
      <div className='flex flex-row justify-between items-center'>
        ...
        <div className='hover:bg-red-600 bg-red-500 py-2 px-5 border border-ahBorderColor rounded-full cursor-pointer'>Delete</div>
      </div>
