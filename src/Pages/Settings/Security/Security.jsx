  ...
  return (
    <div className="flex flex-col text-sm w-full h-full">
      <div>
        ...
        <div className="text-xs text-ahTextColor text-clip mr-36">
          Require an extra security challenge when logging in. If you are unable
          to pass this challenge, you will have the option to recover your
          account via email.
        </div>
      </div>
      ...
      <div>
        ...
        <div className="text-xs text-ahTextColor text-pretty mr-36">
