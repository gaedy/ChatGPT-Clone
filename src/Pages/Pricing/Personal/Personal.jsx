    ...
    <div className=' flex flex-col md:flex-row justify-center items-center gap-4 py-4 md:px-4 '>
            ...
            <div className='border border-ahBorderColor shrink-0 w-11/12 md:w-[50%] md:min-w-80 h-[26rem] md:h-[28rem] rounded-xl p-6 flex flex-col justify-start'>
                ...
                <div className='flex justify-center items-center my-4 mb-6 '>
                    <div className=' border cursor-not-allowed border-ahBorderColor text-sm text-ahTextColor3 rounded-full w-full md:w-64 shadow-lg  text-center p-3 px-3'>Your current plan</div>
                </div>
                ...
                <div className='md:mb-2 mt-auto mb-auto text-xs'>Have an existing plan? See billing help</div>
            ...
            <div className='border border-ahBorderColor shrink-0 w-11/12 md:w-[50%] md:min-w-80 h-[28rem] rounded-xl p-6 flex flex-col justify-start'>
                ...
                <div className='flex justify-center items-center my-4 mb-6 '>
                    <div className=' border cursor-pointer border-ahBorderColor text-sm text-ahTextColor00
                     rounded-full w-full md:w-64 text-center p-3 px-3 bg-emerald-600 hover:bg-emerald-700 shadow-lg '>Upgrade to Plus</div>
                </div>
                ...
                <div className='text-[13px] flex flex-col gap-1'>
                    ...
                    <div className='flex items-start'>
                        <img src={check} className='w-6 scale-[60%] mr-2'></img>
                        <div>Access to data analysis, file uploads, vision, and web browsing</div>
                ...
                <div className='md:mb-2 mt-auto mb-auto text-xs hover:underline cursor-pointer'>Limits apply</div>
