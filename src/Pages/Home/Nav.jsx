...
return (
    <>
        <div 
            className='md:hidden flex flex-row justify-between m-2 mx-3 select-none'
        >
            <div 
            ...
            >
                ...
                />
                <div 
                    className="absolute top-12 bottom-full md:left-0 -left-[57%]"
                >
                    <PopBox 
            ...
            >
                ...
                >
                    ...
                    />
                                                    ...
                                                    {/* Larger Screen */}
        <div 
            className='md:flex  md:justify-center justify-between items-center m-2 mx-3 select-none hidden'
        >
            <Tooltip 
            ...
            >
                ...
                <div 
                    className="absolute left-0 top-12 bottom-full"
                >
                    <PopBox 
                        isOpen={isPopupChatOpen} 
                        refProp={priceRef}
